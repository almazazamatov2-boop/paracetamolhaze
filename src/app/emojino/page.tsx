          ...
          {screen === 'home' && (
            ...
            >
              ...
              <div className="lg:col-span-5 space-y-12">
                <div className="space-y-4 pr-16 overflow-visible">
                  <h1 className="text-7xl font-black tracking-tighter bg-gradient-to-b from-white via-white to-white/40 bg-clip-text text-transparent leading-[0.9] uppercase italic drop-shadow-2xl whitespace-nowrap pr-32 overflow-visible">
                    Угадай <br/> Эмоджи
                  </h1>
                </div>
