...
const PokerConsole = dynamic(() => Promise.resolve(PokerConsoleComponent), { 
  ssr: false,
  loading: () => (
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center">
        <div className="text-primary font-black italic animate-pulse">LOADING POKER ENGINE...</div>
    </div>
  )
})
...
function PokerConsoleComponent() {
